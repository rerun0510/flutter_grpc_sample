...
abstract class $TodoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String content, TodoStatus status});
}
...
class _$_TodoModel extends _TodoModel {
  const _$_TodoModel(
      {required this.id, required this.content, required this.status})
      : super._();
...
abstract class _TodoModel extends TodoModel {
  const factory _TodoModel(
      ...
      required final TodoStatus status}) = _$_TodoModel;
